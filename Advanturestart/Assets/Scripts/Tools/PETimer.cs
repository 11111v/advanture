...
public class PETimer {
    ...
    public PETimer(int interval = 0) {//interval 为定时时间
        tidLst.Clear();
        recTidLst.Clear();
    ...
    /// <param name="delay">延迟时间，包括第一次运行时的延迟</param>
    /// <param name="timeUnit">计时单位</param>
    /// <param name="count">定时次数，0为无限</param>
    /// <returns></returns>
